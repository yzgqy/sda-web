  ...
  <div>
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="对比分析" name="evaluation">
        ...
        <el-row>
          <el-col :span="8">
            <div id="loc_cv" class="barGraph" style="width: 400px;height:300px;"/>
          </el-col>
          <el-col :span="8">
            <div id="not_cv" class="barGraph" style="width: 400px;height:300px;"/>
          </el-col>
          <el-col :span="8">
            <div id="im_cv" class="barGraph" style="width: 400px;height:300px;"/>
          </el-col>
        </el-row>

        <el-row>
          <el-col :span="8">
            <div id="rc_cv" class="barGraph" style="width: 400px;height:300px;"/>
          </el-col>
          <el-col :span="8">
            <div id="is_avg" class="barGraph" style="width: 400px;height:300px;"/>
          </el-col>
          <el-col :span="8">
            <div id="rc_avg" class="barGraph" style="width: 400px;height:300px;"/>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <div id="irn" class="barGraph" style="width: 400px;height:300px;"/>
          </el-col>
        </el-row>
