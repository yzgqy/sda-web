<template>
  <div>
    ...
    <ul class="cardList">
      <li v-for="info in list">
        <el-card shadow="hover">
          <div slot="header">
            <el-row>
              <el-col :span="20">数据描述：{{info.desc}}</el-col>
          ...
          <div>
            <div class="line">
              <el-row>
                <el-col :span="24"><span>{{info.functionName}}</span></el-col>
              </el-row>
            </div>
            <div class="line">
              <el-row>
                <el-col :span="24">
                  <span>创建时间：{{$moment(info.createdAt).format('YYYY-MM-DD HH:mm')}}</span>
                </el-col>
              </el-row>
            </div>
            <div class="line">
    ...
    <el-dialog class= "funcDialog" :title="func.name" :visible.sync="dialogFormVisible_param">
      <!--<el-row>-->
      ...
      <div v-for="(item, index) in func.metaData.metaDataItemList">
        <div :key="index">
          ...
          <div class= "infoLine" v-if="item.dataType === 'FormData'">
            <el-row class="form">
              <el-col :span="4">
                <span>{{ item.name+'：' }}</span>
              </el-col>
          ...
          <!--<div class= "infoLine" v-if="item.dataType === 'InfoData'">-->
              ...
              <!--<el-table v-bind:data="getDataByType(item.type)" height="140" border style="width: 100%">-->
                ...
                <!--<el-table-column label="操作" width="80">-->
                  <!--<template slot-scope="scope">-->
                    <!--&lt;!&ndash;                    <el-button @click="delComponent(scope.row)" type="text" size="small">删除</el-button>&ndash;&gt;-->
                    <!--&lt;!&ndash;                    <el-button @click="editComponent(scope.row)" type="text" size="small">编辑</el-button>&ndash;&gt;-->
      ...
      <el-button @click="execute" type="primary" style="display:block;margin:0 auto">执行</el-button>
