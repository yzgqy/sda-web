      ...
      <el-col :span="24">
        <el-card class="box-card">
          <el-row>
            ...
            <el-col :span="6">
              <div>
                <div class="piechart" id="myChart1">
                </div>
              </div>
            </el-col>
            <el-col :span="4">
              <div>
                <p>微服务候选集指标</p>
                <div>
                  <div v-for="(item, index) in indicators" class="text item">
            ...
            <el-col :span="2">
              <el-button type="primary" plain>评估</el-button>
            </el-col>
          </el-row>
        </el-card>
      </el-col>
            ...
            <el-row>
              <el-col :span="24">
                <div>
                  ...
                  <el-pagination :page-size=8 :current-page=1 @prev-click="preClick" @next-click="nextClick" @current-change="currentChange"
                                 background
  ...
  export default {
    ...
    methods: {
      ...
      getPartitionEdges(edgeId) {
        var _this = this
        this.$http.get("http://localhost:8019/api/partition-detail-edge/" + edgeId + "?pageSize=8&page=1" + this.partitionId).then(function (res) {
      ...
      getPartitionNodes(nodeId) {
        var _this = this
        this.$http.get("http://localhost:8019/api/partition-detail-node/" + nodeId + "?pageSize=8&page=1" + this.partitionId).then(function (res) {
